...
<body>
    ...
    <div class="align-items-center bannerDiv d-flex justify-content-around pageBanner">
        <div class="">
        <img src="<?= base_url()?>assets/images/ecovis_logoes/Mentor_bi.png" alt="" class="mb-4" style=" width: 174px;">
    ...
    <!-- <div class="banner position-relative">
        <img src="<?= base_url()?>assets/ecovis-images/mentor_bi_banner.jpg" style="height:100vh" class="w-100" alt="">
    ...
    <div class="teamMets">
        <div class="justify-content-center mx-0 row">
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center ">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/01_Pankaj_Bhargava.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/06_Sanjeev_Bindal.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center ">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/02_Dheeraj_rathi.jpg" class="w-100" alt="">
                </div>
        ...
        <div class="row mx-0 mx-xl-5">
            ...
            <!-- <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/16_Kevin_Balm.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/22_shruti.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/21_Deepa_rathi.png" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/23_pankaj_monga.jpeg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/05_Manish_Adukia.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <!-- <img src="<?= base_url()?>assets/ourTeam_B&W/08_Ram_Verma.jpg" class="w-100" alt=""> -->
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/09_Parag_Shah.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/03_Bharat_Mishra.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/10_Bala.png" class="w-100" alt="">
                </div>
            ...
            <!-- <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/11_Rahul_Nagar.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/12_Manju_Latha_Boob.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/13_Siddharth_Baghmar.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/14_Jaigovind_boob.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/15_Bharat_Gupta.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/07_Sanjay_Surana.jpg" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/17_Girish_Gangawat.png" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/18_Nidhi_Vira.png" class="w-100" alt="">
                </div>
            ...
            <div class="col-lg-3 mb-5 col-md-4 col-sm-12 text-center">
                <div class="mx-auto rounded-circle" style="width: 160px; height: 160px; overflow: hidden;">
                    <img src="<?= base_url()?>assets/ourTeam_B&W/19_deepa_shetty.jpg" class="w-100" alt="">
                </div>
