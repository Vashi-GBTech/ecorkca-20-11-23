                        ...
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/OffShoreBusinessPlanning.png" class="w-75" alt="">
                                </div>
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/SuccessionPlanning.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/Residency_Programs.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/TrustBusinessCompliance.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/InternationalTax.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/Onshore_Offshore_Advisory/CompanyResolutionMatters.png" class="w-75" alt="">
