...
<head>
    ...
    <title>ECOVISRKCA - careers</title>
...
<body>
        ...
        <div class="w-75 mx-auto">
            <div class="row mx-0 border border-danger mb-4" style="border-radius: 7px;box-shadow: 0px 1px 5px 1px #cececc">
                ...
                <div class="col-md-9">
                    ...
                    <div class="my-4 pt-2 text-center w-75"><a href="<?= base_url()?>assets/Marketing_head"><button style="    box-shadow: 0px 1px 5px 1px grey" class="btn btn-danger px-4 font-weight-bold text-light">VIEW DETAILS</button></a></div>
                </div>
            ...
            <div class="row mx-0 border border-danger mb-4" style="border-radius: 7px;     box-shadow: 0px 1px 5px 1px #cececc">
                ...
                <div class="col-md-9">
                    ...
                    <div class="my-4 pt-2 text-center w-75"><a href="<?= base_url()?>assets/Business_Analyst"><button style="    box-shadow: 0px 1px 5px 1px grey" class="btn btn-danger  px-4 font-weight-bold text-light">VIEW DETAILS</button></a></div>
                </div>
    ...
    <div class="lets_connect px-0 text-center">
       <a href="<?= base_url()?>assets/jobApplication"> <button type="submit" class="lets_connect_button" style="box-shadow: 0px 1px 4px 1px grey;cursor: pointer;">APPLY</button></a>
