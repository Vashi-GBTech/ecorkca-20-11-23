    ...
    <div class="banner ">
        ...
        <div class="row" style="margin-bottom: 100px;">
            ...
            <div class="col-md-8"   style="text-align: center;" >
                <div class="row">
              <div class="col-md-4">
                <i class="fa-regular fa-envelope text-danger mr-2" style="font-size:100px; "></i>
                <h1>EMAIL</h1>
                <p style="color: #dc3545;font-size: 18px;">info@ecovisrkca.com</p>
            </div>
              <div class="col-md-4">
                <i class="fa-solid fa-mobile-screen-button text-danger mr-2" style="font-size:100px;"></i>
                <h1>CALL</h1>
                <p style="color: #dc3545; font-size: 18px;">+44 (0)20 7495 2244</p>
            </div>
              <div class="col-md-4">
                <i class="fa-solid fa-location-dot text-danger mr-2" style="font-size: 100px;"></i>
                <h1>VISIT</h1>
                <p style="color: #dc3545; font-size: 18px;">Select The Branch</p>
            </div>
            </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class="row justify-content-around mx-0 bg-img-contact" style="margin-top: -38px;">
            <div class="col-md-9">
                <h4 class="mb-4 mt-4 text-center">Want to know more about us? Leave us a message</h3>
                    <form action="" class="form-group mb-5" method="post">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="email" id="email" class="form-control bg-light input-contact  ml-4 col-sm-12" style="margin-left: 0px !important;" placeholder="Email" style="margin-right:15px;">

                                </div>
                                <div class="col-md-4 col-sm-12 py-2">
                                <input type="text" name="first_name" id="first_name" class="form-control input-contact bg-light mr-3 col-sm-12" placeholder="First Name">
                                </div>

                                <div class="col-md-4 col-sm-12 py-2">
                                <input type="text" name="last_name" id="last_name" class="form-control input-contact bg-light col-sm-12" placeholder="Last Name">
                                </div>
                                    </div>


                        <span style="font-size:20px;">Your message or query : </span>
                        <textarea class="form-control message-contact bg-light mt-2 mb-3" rows="2" style=" border-radius: 6px;"></textarea>
                        <p style="font-size:20px;" class="mb-2 text-center">Our team will get in touch with you as soon as possible.</p>
                        <div class="text-center mt-4">
                            <button type="submit" class="bg-danger btn box_shadow font-weight-bold text-light" style="width:auto;">SUBMIT</button>
        ...
        <!-- <div class="row d-flex justify-content-around mb-5">
            ...
            <div class="align-items-center justify-content-center d-flex col-md-6 col-sm-12">
